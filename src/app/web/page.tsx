...
export default async function WebPage() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-center mb-8">
        <div className="w-full max-w-lg rounded-2xl p-8" style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-base font-semibold" style={{ color: "var(--text-primary)" }}>Connect Google Analytics 4</h2>
      ...
      {/* Placeholder metrics */}
      <h2 className="text-sm font-semibold mb-3" style={{ color: "var(--text-primary)" }}>Available Once Connected</h2>
