  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-center mb-8">
        <div className="w-full max-w-lg rounded-2xl p-8" style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-base font-semibold" style={{ color: "var(--text-primary)" }}>Connect Zendesk</h2>
      ...
      <div className="rounded-xl p-4 mb-6 flex items-start gap-3"
        ...
        <div>
          <p className="text-xs font-semibold mb-1" style={{ color: "var(--text-primary)" }}>AI-powered ticket analysis — coming soon</p>
